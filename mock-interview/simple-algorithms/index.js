...
/*
  ...
  3. Compare length of the current element with the initialized variable 
  4. if the length of the current element is greater than the initialized variable 
  then replace the empty string with current element
